 ...
 */
package com.spiceos.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.spiceos.build.version";
    public static final String PROP_DEVICE = "ro.spiceos.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "spiceos.updater.allow_downgrading";
